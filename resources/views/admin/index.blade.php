...
@section('content')
            ...
            <div class="table-responsive">
                <table class="table table-highlight-head bg-transparent m-0">
                    ...
                    <tr>
                        ...
                        <th class="border-top-0 text-right">Müşteri</th>
                        ...
                        @foreach($customers as $customer)
                            <tr>
                                <td class="pl-4" style="width: 1px">
                                    @if(Cache::has('user-is-online-' . $customer->id))
                                ...
                                <td>
                                    <a href="{{ route('back.admin.customer.view', ['id' => $customer->id]) }}">
                                        {{ $customer->username }}
                                    </a>
                                </td>
                                <td class="text-right">{{ $customer->users->count() }}</td>
    ...
    <div class="layout">
        ...
        <div class="layout-content">
            <form action="{{ route('back.admin.customer.insert') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="username">Bayi Adı</label>
                        ...
                        <div class="form-group">
                            <div class="n-chk">
                                <label class="new-control new-checkbox new-checkbox-text checkbox-success">
                                    <input type="checkbox" class="new-control-input" name="limitless" value="1">
                                    <span class="new-control-indicator"></span>
                                    <span class="new-chk-content">Limitsiz</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <button class="btn btn-primary btn-lg">Bayi Ekle</button>
                    </div>
                </div>
            </form>
        </div>
